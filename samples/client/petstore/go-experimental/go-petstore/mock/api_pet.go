...
// Package mock_petstore is a generated GoMock package.
package mock_petstore
...
func (m *MockPetApi) AddPetGetRequest(ctx context.Context) petstore.ApiAddPetRequest {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddPetGetRequest", ctx)
	ret0, _ := ret[0].(petstore.ApiAddPetRequest)
	return ret0
}
...
func (m *MockPetApi) AddPetExecute(r petstore.ApiAddPetRequest) (*http.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockPetApi) DeletePetGetRequest(ctx context.Context, petId int64) petstore.ApiDeletePetRequest {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeletePetGetRequest", ctx, petId)
	ret0, _ := ret[0].(petstore.ApiDeletePetRequest)
	return ret0
}
...
func (m *MockPetApi) DeletePetExecute(r petstore.ApiDeletePetRequest) (*http.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockPetApi) FindPetsByStatusGetRequest(ctx context.Context) petstore.ApiFindPetsByStatusRequest {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindPetsByStatusGetRequest", ctx)
	ret0, _ := ret[0].(petstore.ApiFindPetsByStatusRequest)
	return ret0
}
...
func (m *MockPetApi) FindPetsByStatusExecute(r petstore.ApiFindPetsByStatusRequest) ([]petstore.Pet, *http.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindPetsByStatusExecute", r)
	ret0, _ := ret[0].([]petstore.Pet)
...
func (m *MockPetApi) FindPetsByTagsGetRequest(ctx context.Context) petstore.ApiFindPetsByTagsRequest {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindPetsByTagsGetRequest", ctx)
	ret0, _ := ret[0].(petstore.ApiFindPetsByTagsRequest)
	return ret0
}
...
func (m *MockPetApi) FindPetsByTagsExecute(r petstore.ApiFindPetsByTagsRequest) ([]petstore.Pet, *http.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockPetApi) GetPetByIdGetRequest(ctx context.Context, petId int64) petstore.ApiGetPetByIdRequest {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPetByIdGetRequest", ctx, petId)
	ret0, _ := ret[0].(petstore.ApiGetPetByIdRequest)
	return ret0
}
...
func (m *MockPetApi) GetPetByIdExecute(r petstore.ApiGetPetByIdRequest) (petstore.Pet, *http.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockPetApi) UpdatePetGetRequest(ctx context.Context) petstore.ApiUpdatePetRequest {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdatePetGetRequest", ctx)
	ret0, _ := ret[0].(petstore.ApiUpdatePetRequest)
	return ret0
}
...
func (m *MockPetApi) UpdatePetExecute(r petstore.ApiUpdatePetRequest) (*http.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockPetApi) UpdatePetWithFormGetRequest(ctx context.Context, petId int64) petstore.ApiUpdatePetWithFormRequest {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdatePetWithFormGetRequest", ctx, petId)
	ret0, _ := ret[0].(petstore.ApiUpdatePetWithFormRequest)
	return ret0
}
...
func (m *MockPetApi) UpdatePetWithFormExecute(r petstore.ApiUpdatePetWithFormRequest) (*http.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockPetApi) UploadFileGetRequest(ctx context.Context, petId int64) petstore.ApiUploadFileRequest {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UploadFileGetRequest", ctx, petId)
	ret0, _ := ret[0].(petstore.ApiUploadFileRequest)
	return ret0
}
...
func (m *MockPetApi) UploadFileExecute(r petstore.ApiUploadFileRequest) (petstore.ApiResponse, *http.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UploadFileExecute", r)
	ret0, _ := ret[0].(petstore.ApiResponse)
	ret1, _ := ret[1].(*http.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockPetApi) UploadFileWithRequiredFileGetRequest(ctx context.Context, petId int64) petstore.ApiUploadFileWithRequiredFileRequest {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UploadFileWithRequiredFileGetRequest", ctx, petId)
	ret0, _ := ret[0].(petstore.ApiUploadFileWithRequiredFileRequest)
	return ret0
}
...
func (m *MockPetApi) UploadFileWithRequiredFileExecute(r petstore.ApiUploadFileWithRequiredFileRequest) (petstore.ApiResponse, *http.Response, error) {
	m.ctrl.T.Helper()
